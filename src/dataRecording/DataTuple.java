...
public class DataTuple {
	...
	public DataTuple(String data) {
		...
		//extra info added by dani and carlos
		this.blinkyPosition = Integer.parseInt(dataSplit[25]);
		this.inkyPosition = Integer.parseInt(dataSplit[26]);
		this.pinkyPosition = Integer.parseInt(dataSplit[27]);
		this.suePosition = Integer.parseInt(dataSplit[28]);
	}
